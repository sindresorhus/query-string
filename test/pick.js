...
test('picks elements in a URL with a filter array', t => {
	t.is(pick('http://example.com/?a=1&b=2&c=3#a', ['a', 'b']), 'http://example.com/?a=1&b=2#a');
});

test('picks elements in a URL with a filter predicate', t => {
	t.is(pick('http://example.com/?a=1&b=2&c=3#a', (name, value) => {
...
test('picks elements in a URL without encoding fragment identifiers', t => {
	t.is(pick('https://example.com?a=b#/home', []), 'https://example.com#/home');
});
